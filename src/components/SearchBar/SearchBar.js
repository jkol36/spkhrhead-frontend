...
const ENTER_KEY = 13;
const SEARCH_BUTTON_EDGE = 30;
const SEARCH_FIELD_WIDTH = 1000

const searchFieldStyle = (width) => {
  return {
    border: '1px #440b77 solid',
    marginTop: 20,
    marginLeft: 0,
    borderRadius: 20,
    display: 'inline-flex',
    ...
    width: width ? width: SEARCH_FIELD_WIDTH,
    textAlign: 'center'
  }
